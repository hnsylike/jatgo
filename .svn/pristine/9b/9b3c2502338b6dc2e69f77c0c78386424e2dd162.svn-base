...
public class AgClientServiceImpl implements AgClientService {
	...
	@Override
	public List<AgClient> getByCustomerId(long customerId) {
		return wsDao.selectByCustomer(customerId).orElse(Collections.emptyList());
	}

	@Override
	public List<AgClient> getByUserId(long userId) {
